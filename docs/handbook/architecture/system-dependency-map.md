...
| Lexical evolution | Authentic committed-transfer communication, selected pre-existing usable production | Deterministic descendant emission, direct-edge provenance, individual lexical competition, enabled hash only |
...
| Language/dialects/contact/intergenerational/lexical | - | - | - | - | - | - | C | - | H |
...
- Language, dialect, contact, intergenerational, or lexical state -> transfer success, partner choice,
...
- Lexical opportunities occur only inside `communicate()` after an individual
  or faction-mediated transfer has committed. One selected pre-existing usable
  form may produce the actual emitted descendant; a language failure rolls
  back language owners and the derivation index, not the committed transfer.
